...
export const LandingPage = () => {
  ...
  return (
    <main className={styles['landing-page--container']}>
        ...
        <Image priority={true} width={500} height={500}   ref={(el) => (parallax_el.current[4] = el)} src={MountBack} alt="Img Mount Back" data-speedx='0.05' data-speedy='0.08' className={`${styles['mountain']} ${styles['parallax']} ${styles['lading-page-mountBack']}`} />
